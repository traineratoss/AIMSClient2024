...
function removeSelection(selectionType, index) {
    ...
    switch (selectionType) {
        case 'statusType':
            statusSelected.value = statusSelected.value.filter((status, index) => indexValue !== index);
            break;
        case 'categoryType':
            categoriesSelected.value = categoriesSelected.value.filter((category, index) => indexValue !== index);
            break;
        case 'userType':
            userSelected.value = userSelected.value.filter((user, index) => indexValue !== index);
            break;
    }
}
